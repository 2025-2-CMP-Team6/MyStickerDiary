...
/**
 * 이미지의 원본 비율을 유지하면서 주어진 사각형 박스에 맞게 크기를 조절한 PVector(너비, 높이)를 반환합니다.
 * @param img 크기를 조절할 PImage
 * @param boxW 목표 너비
 * @param boxH 목표 높이
 * @return 조절된 너비와 높이를 담은 PVector
 */
...
/**
 * 이미지의 원본 비율을 유지하면서 주어진 정사각형 박스에 맞게 크기를 조절한 PVector(너비, 높이)를 반환합니다.
 * @param img 크기를 조절할 PImage
 * @param boxSize 목표 정사각형의 한 변 길이
 * @return 조절된 너비와 높이를 담은 PVector
 */
